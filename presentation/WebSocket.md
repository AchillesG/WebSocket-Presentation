...
![WebSocket](./img/api-interface.png)

📝 interface: WebSocket 是与服务端连接的主接口，连接后也通过它进行数据的发送接收

👇

![WebSocket](./img/api-property.png)
...
![WebSocket](./img/api-eventListener.png)
<!-- .element: style="width: 80%" -->
